...
const STRIPE_BASIC_URL = process.env.NEXT_PUBLIC_STRIPE_BASIC_URL ?? "#"
const STRIPE_INTERMEDIATE_URL = process.env.NEXT_PUBLIC_STRIPE_INTERMEDIATE_URL ?? "#"
...
const PLANS = [
    ...
    },
    {
        ...
        stripeUrl: STRIPE_INTERMEDIATE_URL,
        cta: "Get Started",
        highlighted: true,
        icon: Sparkles,
    },
...
export default function PlansPage() {
    ...
    async function selectPlan(planId: "basic" | "intermediate" | "custom", stripeUrl: string | null) {
        setLoading(planId)
        try {
                    ...
                    {PLANS.map((plan) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <Button
                                    onClick={() => selectPlan(plan.id, plan.stripeUrl)}
                                    disabled={!!loading}
